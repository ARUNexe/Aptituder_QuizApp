...
class Physics_aptitude : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_physics_aptitude)
        ...
        var level2_img = sharedPreference.getBoolean("Sub4_level2",false)
        var level3_img = sharedPreference.getBoolean("Sub4_level3",false)

        var level1_prize = sharedPreference.getBoolean("Sub4_level1_prize",false)
        var level2_prize = sharedPreference.getBoolean("Sub4_level2_prize",false)
        var level3_prize = sharedPreference.getBoolean("Sub4_level3_prize",false)
